...
namespace EducationalInstitution.Infrastructure.Security
{
    public class JwtTokenService : ITokenService
    {
        ...
        {
            // Implementar lógica de blacklist si es necesario
        ...
        {
            // Implementar lógica para agregar token a blacklist
            // Se puede usar Redis, base de datos, etc.
